...
PhpDebugToolbar = function(container, options)
{
    ...
    this.toggle_button.innerHTML = '<span title="show DebugToolbar" class="ui-icon ui-icon-circle-triangle-w">PhpDebugToolbar [show]</span>';
    this.toggle_button.setAttribute('class', 'ui-state-default ui-corner-all');
...
PhpDebugToolbar.prototype.show = function()
{
    ...
    this.toggle_button.innerHTML = '<span title="hide DebugToolbar" class="ui-icon ui-icon-circle-triangle-e">[hide]</span>';
