var Storage, StorageArea, StorageEvent, Storages, events, html;
  ...
  function Storages(browser) {
    ...
    this.extend = function(window) {
      window.__defineGetter__("sessionStorage", function() {
        var _ref;
        return (_ref = this.document) != null ? _ref._sessionStorage || (_ref._sessionStorage = browser.sessionStorage(this.location.host)) : void 0;
      });
      return window.__defineGetter__("localStorage", function() {
        var _ref;
        return (_ref = this.document) != null ? _ref._localStorage || (_ref._localStorage = browser.localStorage(this.location.host)) : void 0;
      });
    };
    this.dump = function() {
