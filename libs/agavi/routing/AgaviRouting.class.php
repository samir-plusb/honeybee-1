 ...
 * @since      0.11.0
 *
 * @version    $Id: AgaviRouting.class.php 4669 2011-05-25 20:53:42Z david $
 */
abstract class AgaviRouting extends AgaviParameterHolder
{
	...
	protected function parseInput(array $route, $input, &$matches)
	{
		...
		/* @todo Remove debug code AgaviRouting.class.php from 16.09.2011 */
		$this->getContext()->getLoggerManager()->log(__CLASS__.":".__FUNCTION__.":".__LINE__);
		$this->getContext()->getLoggerManager()->log($route['rxp'].", $input");
