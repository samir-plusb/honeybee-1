midas.core.EditController = midas.core.BaseObject.extend({
...
// #     static methods     #
// ##########################
midas.core.EditController.factory = function(element)
{
    element = $(element);
    var options = $.extend(
        {},
        midas.core.EditController.DEFAULT_OPTIONS,
        JSON.parse(element.attr('data-edit-controller-options') || "{}")
    );
    options.widgets = options.widgets || [];
    return new midas.core.EditController(element, options);
};
