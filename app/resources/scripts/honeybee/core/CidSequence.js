 ...
 * @version $Id:$
 */
honeybee.core.CidSequence = honeybee.core.BaseObject.extend(
/** @lends honeybee.core.CidSequence.prototype */
{
    /**
 ...
 */
honeybee.core.CidSequence.nextCid = function(receiver_type)
{
    if (! honeybee.core.CidSequence._instance)
    {
        honeybee.core.CidSequence._instance = new honeybee.core.CidSequence();
    }

    return honeybee.core.CidSequence._instance.nextCid(receiver_type);
}