...
/**
 * The Events_SuggestAction class is responseable for delivering movie suggests (autocomplete).
 *
 * @version         $Id: Events_SuggestAction.class.php -1   $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <tschmittrink@gmail.com>
 * @package         Events
 * @subpackage      Mvc
 */
class Events_SuggestAction extends EventsBaseAction
{
    /**
    ...
    public function executeRead(AgaviRequestDataHolder $parameters)
    {
        ...
        $finder = EventsFinder::create($listConfig);
