...
/**
 * The ItemsListBaseAction serves as a base to all (item) actions that relate to list style data
 ...
 * @subpackage      Mvc
 */
class ItemsListBaseAction extends ItemsBaseAction
{
    /**
     ...
     */
    const DEFAULT_SORT_DIRECTION = ItemFinder::SORT_DESC;
    ...
    protected function setActionAttributes(AgaviRequestDataHolder $parameters)
    {
        ...
        $this->setAttribute('limit', $parameters->getParameter('limit', ItemFinder::DEFAULT_LIMIT));
        ...
        $this->setAttribute('finder', new ItemFinder(
            new Elastica_Client(
                array(
    ...
    /**
     * Helper metod for invoking the correct retrieval method on our ItemFinder,
