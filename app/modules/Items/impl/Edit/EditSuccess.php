...
<menu class="action-button-list">
    ...
    <li><a href="#complete">Abhaken</a></li>
</menu>
...
<section class="document-editing">
    ...
    <form accept-charset="utf-8" action="#postdata" method="post">
        ...
        <fieldset class="content-panel">
            <legend>Redaktionelle Einstellungen</legend>
        ...
        <fieldset class="geo-data content-panel">
            <legend>Geo</legend>
        ...
        <fieldset class="datetime-data content-panel">
...
<section class="document-data">
    <section class="item-pool content-panel">
        <h2>Items</h2>
        <ul>
            <li data-template="">
                <article>
    ...
    <section class="item-meta-data content-panel">
        <h2>Meta Daten</h2>
        <dl>
            <dt>Betreff</dt>
            <dd></dd>
    ...
    <section class="item-content content-panel">
        <h2>Content</h2>
        <ul>
            <li>
                <a href="#content-tab-1">Inhalt</a>
            </li>
        </ul>
