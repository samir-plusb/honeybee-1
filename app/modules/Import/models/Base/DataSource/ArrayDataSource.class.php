...
/**
 * The ArrayDataSource class is a concrete implementation of the ImportBaseDataSource base class.
 ...
 */
class ArrayDataSource extends ImportBaseDataSource
{
    // ---------------------------------- <MEMBERS> ----------------------------------------------
    ...
    {
        $this->data = $this->config->getSetting(ArrayDataSourceConfig::CFG_DATA, array());
