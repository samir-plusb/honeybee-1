...
/**
 * The BaseDataSource class is an abstract implementation of the IDataSource interface.
...
abstract class BaseDataSource implements IDataSource
{
    ...
    /**
     * Create a new BaseDataSource instance.
     *
     ...
     *
     * @uses        BaseDataSource::init()
     * @uses        BaseDataSource::forwardCursor()
     * @uses        BaseDataSource::createRecord()
     * @uses        BaseDataSource::fetchData()
     */
