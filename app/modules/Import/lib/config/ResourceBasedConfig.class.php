...
/**
 * The ResourceBasedConfig class is an abstract implementation of the BaseConfig base.
 ...
 * Every IConfig that gets it's settings from some kind of resource,
 ...
 * @subpackage      Config
 */
abstract class ResourceBasedConfig extends BaseConfig implements IUriContainer
{
    // ---------------------------------- <MEMBERS> ----------------------------------------------
