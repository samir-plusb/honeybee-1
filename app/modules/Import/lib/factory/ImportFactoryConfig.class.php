...
/**
 * The ImportFactoryConfig class is an abstract implementation of the AgaviXmlConfig base class.
 ...
 * @subpackage      Factory
 */
class ImportFactoryConfig extends BaseConfig implements IImportFactoryConfig
{
    // ---------------------------------- <CONSTANTS> --------------------------------------------
    ...
    protected function load($configSrc) // @codingStandardsIgnoreEnd
    {
        ...
        {
            throw new ImportFactoryException(
                "Can not create ImportFactoryConfig without a valid config path, given: " . $configSrc
            );
        }
     ...
     * @return      array
     *
     * @see         BaseConfig::getRequiredSettings()
     */
