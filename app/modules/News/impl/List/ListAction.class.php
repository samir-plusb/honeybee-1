...
/**
 * The News_ListAction is repsonseable for loading the news items list thereby exposing several parameters
 ...
 * @subpackage      Mvc
 */
class News_ListAction extends NewsListBaseAction
{
    /**
