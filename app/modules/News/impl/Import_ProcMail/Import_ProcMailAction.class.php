...
/**
 * The News_Import_ProcMailAction class is responseable for receiving procmail notifications
 ...
 * @subpackage      Mvc
 */
class News_Import_ProcMailAction extends NewsBaseAction
{
    /**
     ...
     */
    const DATASOURCE_NAME = 'procmail';
    ...
    public function executeWrite(AgaviRequestDataHolder $parameters)
    {
        try
        {
            ...
            $dataImport->run($importFactory->createDataSource(
                ...
                array(
                    ArrayDataSourceConfig::CFG_DATA => array(
                        $parameters->getParameter(ImportMailValidator::DEFAULT_PARAM_EXPORT)
                    )
                )
            ));
            return 'Success';
