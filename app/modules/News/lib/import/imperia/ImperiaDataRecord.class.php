...
/**
 * The ImperiaDataRecord class is a concrete implementation of the NewsDataRecord base class.
 ...
 */
class ImperiaDataRecord extends NewsDataRecord
{
    // ---------------------------------- <CONSTANTS> --------------------------------------------
     ...
     */
    const LINK_BASE_URL_SETTING = 'news.imperia.asset_base_href';
    ...
    protected function createAsset(array $imageInfo)
    {
        ...
        return ProjectAssetService::getInstance()->put($src, $imageInfo)->getIdentifier();
    }
