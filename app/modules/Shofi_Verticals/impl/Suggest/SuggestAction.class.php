...
/**
 * The Shofi_Verticals_SuggestAction class is responseable for delivering shofi vertical suggests (autocomplete).
 *
 * @version         $Id: Shofi_Verticals_SuggestAction.class.php -1   $
 * @copyright       BerlinOnline Stadtportal GmbH & Co. KG
 * @author          Thorsten Schmitt-Rink <tschmittrink@gmail.com>
 * @package         Shofi_Verticals
 * @subpackage      Mvc
 */
class Shofi_Verticals_SuggestAction extends ShofiVerticalsBaseAction
{
    /**
    ...
    public function executeRead(AgaviRequestDataHolder $parameters)
    {
        ...
        $finder = ShofiVerticalsFinder::create($listConfig);
