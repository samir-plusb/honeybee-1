...
class HoneybeeDocumentCollection implements Countable, ArrayAccess, Iterator 
{
    private $documents;
    ...
    public function add(HoneybeeDocument $document)
    {
        $this->documents[] = $document;
    }

    public function remove(HoneybeeDocument $document)
    {
