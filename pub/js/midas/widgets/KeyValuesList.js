midas.widgets.KeyValuesList = midas.widgets.Widget.extend({
    ...
    {
        return midas.widgets.KeyValuesList.TPL;
    },
...
// ####################################
midas.widgets.KeyValuesList.KeyValuesPair = midas.core.BaseObject.extend({
...
// #     constants     #
// #####################
midas.widgets.KeyValuesList.DEFAULT_OPTIONS = {
    autobind: true,
    fieldname: 'keyvalueslist'
};

midas.widgets.KeyValuesList.TPL = ''
