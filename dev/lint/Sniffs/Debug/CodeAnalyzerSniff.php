<?php
/**
 * BerlinOnline_Sniffs_Debug_CodeAnalyzerSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Holger Kral <holger.kral@BerlinOnline.com>
 ...
 * BerlinOnline_Sniffs_Debug_CodeAnalyzerSniff.
 *
 * Runs the BerlinOnline Code Analyzer (from BerlinOnline Studio) on the file.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Holger Kral <holger.kral@BerlinOnline.com>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BerlinOnline_Sniffs_Debug_CodeAnalyzerSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $analyzerPath = PHP_CodeSniffer::getConfigData('BerlinOnline_ca_path');
        ...
        if (is_numeric($exitCode) === true && $exitCode > 0) {
            ...
            throw new PHP_CodeSniffer_Exception("Failed invoking BerlinOnlineCodeAnalyzer, exitcode was [$exitCode], retval was [$retval], output was [$msg]");
        }
        ...
        if (is_array($output) === true) {
            ...
            foreach ($output as $finding) {
                ...
                // something like this:
                // > BerlinOnline Code Analyzer 1.2.2
                // > Analyzing <filename>...
                // So skip these...
